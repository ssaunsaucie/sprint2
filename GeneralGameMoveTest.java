...
public class GeneralGameMoveTest {
    ...
    @Before
    public void setUp() {
        // sets up a default board size 3x3 and mode to General
        logic = new SOSGameLogic(3, false);  
    }
    ...
    public void testUnsuccessfulMoveOnOccupiedCell() {
        ...
        assertEquals("Player turn should remain the same", initialPlayerTurn, logic.isPlayerTurn());
    }
